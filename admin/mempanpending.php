...
?>
 <a href="mempanpending.php">PENDING LIST<a>  <br>
 <a href="mempancardverifiy.php"> VERIFIED LIST <a>  <br>
 <a href="mempanreject.php"> REJECTED LIST<a>  <br>
 <a href="mempannotupload.php"> NOT UPLOADED LIST<a> 
		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">S.L</th>
                ...
                <th class="text-center" scope="col">PANCARD NUMBER</th>
				<th class="text-center" scope="col">MOBILE</th>
				<th class="text-center" scope="col">PANCARD FILE</th>
