		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">S.L</th>
                ...
                <th class="text-center" scope="col">PROMOTION TYPE</th>
				<th class="text-center" scope="col">DEMOTED</th>
				<th class="text-center" scope="col">PROMOTION LEVEL</th>
				<th class="text-center" scope="col">CURRENT LEVEL</th>
                <th class="text-center" scope="col">PROMOTED DATE</th>
			</tr>
		</thead>
