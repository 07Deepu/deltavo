...
<a href="closedlist.php"> CLOSED LIST<a> 
  <div id="myTable_wrapper" class="dataTables_wrapper no-footer">
    ...
    <table class="table table-bordered table-striped table-hover dataTable no-footer" id="myTable" role="grid"
        ...
        <th class="text-center" scope="col">FRENCHISE NAME</th>
		...
		<?php
        	...
        	$get_data = "SELECT DISTINCT fcr.updated_date ,fcr.transation_id,fcr.request_amount,fcr.comments,fl.user_name,fl.members_id  from franchise_credit_reports fcr , franchise_login fl  where fcr.user_id=fl.user_id";
