  ...
  <div id="myTable_wrapper" class="dataTables_wrapper no-footer">
    ...
    <table class="table table-bordered table-striped table-hover dataTable no-footer" id="myTable" role="grid"
		...
		<?php
        	...
        	$get_data = "SELECT fcr.updated_date ,fcr.transation_id,fcr.request_amount,fcr.comments,fl.user_name,fl.members_id from franchise_credit_reports fcr , franchise_login fl where fcr.user_id=fl.user_id and fcr.status=1";
